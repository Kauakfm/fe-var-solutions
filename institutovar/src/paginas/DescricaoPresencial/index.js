...
export default function DescricaoPresencial() {
    ...
    return (
        <div className='body-curso-online'>
            ...
            <div className='textos'>
                ...
                <p>Oferecemos opções gratuitas para pessoas de baixa renda, e para os demais temos um cálculo que determina o valor do curso, variando de gratuito até R$199,00 de acordo com a renda per capita, assegurando que o conhecimento seja acessível a todos, independentemente da situação financeira e atendendo um público a partir de 16 anos.</p>
                <Link to={`/planos/presencial/inscricao`} className='adquirir-curso'><button>Fazer inscrição</button></Link>
            </div>
            ...
            <div className='curso'>
                ...
                <p className='p-2'>Oferecemos opções gratuitas para pessoas de baixa renda, e para os demais temos um cálculo que determina o valor do curso, variando de gratuito até R$199,00 de acordo com a renda per capita, assegurando que o conhecimento seja acessível a todos, independentemente da situação financeira e atendendo um público a partir de 16 anos.</p>
                <Link to={`/planos/presencial/inscricao`} className='adquirir-curso'><button>Fazer inscrição</button></Link>
            </div>
